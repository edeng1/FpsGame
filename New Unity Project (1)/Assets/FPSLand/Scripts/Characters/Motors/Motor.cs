...
namespace FirstGearGames.FPSLand.Characters.Motors
{
    ...
    public class Motor : NetworkBehaviour
    {
        ...
        /// </summary>
        [Replicate]
        private void Replicate(ReplicateData input, bool asServer, bool replaying = false)
        {
        ...
        /// </summary>
        [Reconcile]
        private void Reconcile(ReconcileData rd, bool asServer)
        {
        ...
        private void CheckInput(out ReplicateData rd)
        {
            ...
            if (actionCodes != ActionCodes.None)
                rd.Tick = base.TimeManager.LocalTick;
        }
